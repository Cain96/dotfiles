...
description: >-
  PR履歴を整理し、説明とレビュアー向けガイドを改善してレビュー容易性を高める（挙動は変えない）。
  Use for "make this easy to review", "tidy this PR", "clean up commits", or "annotate the diff".
...
Report at the end with a concise summary of what you changed in Japanese.
