---
name: web-search
description: Advanced web search capability using the gemini command for gathering current, relevant information. Activated when complex research or up-to-date information is needed.
