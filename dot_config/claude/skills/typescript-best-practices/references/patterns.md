...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic; see [`type-system-discipline`](../../engineering-principles/references/type-system-discipline.md) and [`boundary-discipline`](../../engineering-principles/references/boundary-discipline.md).
...
Validate once where data crosses in; trust types inside. See [`boundary-discipline`](../../engineering-principles/references/boundary-discipline.md).
